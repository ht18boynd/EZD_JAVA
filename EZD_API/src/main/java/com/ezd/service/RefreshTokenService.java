...
import com.ezd.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
	...
	public RefreshToken createRefreshToken(Long id) {
		Optional<RefreshToken> existToken = refreshTokenRepository.findByAuth_Id(id);
...
//			refreshToken.setExpiryDate(Instant.now().plusMillis(refreshTokenDurationMs));
	...
	public int deleteByUserId(Long id) {
		return refreshTokenRepository.deleteByAuth(authRepository.findById(id).get());
	}
}
